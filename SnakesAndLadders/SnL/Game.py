...
class Game:
  ...
  def incrementPoints(self, house: str, amount: int) -> bool:
  ...
  def getPoints(self, house: str) -> int:
    player = self.__PLAYERS[house]
  ...
  def roll(self, house: str, steps: int) -> bool:
    player = self.__PLAYERS[house]
  ...
  def sabo(self, house: str, other: str) -> bool:
    player = self.__PLAYERS[house]
